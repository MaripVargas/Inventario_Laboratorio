...
use App\Exports\FisicoquimicaAdsorcionAtomicaEquiposExport;
...
class FisicoquimicaAdsorcionAtomicaEquiposController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('labs.fisicoquimica.adsorcion_atomica_equipos.index', compact('items'));
    }

    public function create()
    {
        $catalogos = $this->getCatalogos();
        return view('labs.fisicoquimica.adsorcion_atomica_equipos.create', compact('catalogos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        FisicoquimicaAdsorcionAtomicaEquipo::create($request->all());

        return redirect()->route('fisicoquimica.adsorcion_equipos.index')
                         ->with('success', 'Equipo agregado correctamente.');
    }

    public function edit($id)
    {
        $item = FisicoquimicaAdsorcionAtomicaEquipo::findOrFail($id);
        $catalogos = $this->getCatalogos();
        return view('labs.fisicoquimica.adsorcion_atomica_equipos.edit', compact('item', 'catalogos'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('exports.fisicoquimica.adsorcion_atomica_equipos', [
            'items' => $items,
            'generatedAt' => now(),
        ])->setPaper('A4', 'landscape');

        return $pdf->download('fisicoquimica_adsorcion_atomica_equipos_' . now()->format('Y-m-d_His') . '.pdf');
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(
            new FisicoquimicaAdsorcionAtomicaEquiposExport($items),
            'fisicoquimica_adsorcion_atomica_equipos_' . now()->format('Y-m-d_His') . '.xlsx'
        );
    }
    ...
    private function getCatalogos()
    {
        ...
        $equipos = FisicoquimicaAdsorcionAtomicaEquipo::select(
            'nombre_responsable',
            'cedula',
            'vinculacion',
            'usuario_registra'
    ...
    {
        return FisicoquimicaAdsorcionAtomicaEquipo::query()
