    ...
    <div class="modern-inventory-container">
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                @forelse($items as $item)
                                    <tr class="table-row" data-item-id="{{ $item->id }}">
                                        ...
                                        <td class="table-cell">{{ $item->fecha_adq ? $item->fecha_adq->format('d/m/Y') : '-' }}
                                        </td>
                ...
                <div class="mt-6 flex justify-between items-center">
                    <div class="text-sm text-gray-700">
                        Mostrando {{ $items->firstItem() ?? 0 }} a {{ $items->lastItem() ?? 0 }} de {{ $items->total() }}
                        resultados
                    </div>
        ...
        <style>
            ...
            .modern-table {
                width: 100%;
                min-width: 1800px;
                /* Asegurar que todas las columnas tengan espacio */
