...
@section('title', 'Vidriería - Fisico Química')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('fisicoquimica.vidrieria.create') }}" class="modern-btn modern-btn-primary">
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                       <a href="{{ route('fisicoquimica.vidrieria.edit', $item->id) }}" class="btn btn-warning btn-sm btn-edit" title="Editar">
    <i class="fas fa-edit"></i>
</a>

                                        <form action="{{ route('fisicoquimica.vidrieria.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
