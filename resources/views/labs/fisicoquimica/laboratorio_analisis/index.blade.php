...
@section('title', 'Laboratorio de Análisis - Físico Química')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Gestión de laboratorio de análisis')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-900">Laboratorio de Análisis</h2>
                <a href="{{ route('fisicoquimica.laboratorio_analisis.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.laboratorio_analisis.export.pdf',
            'excelRoute' => 'fisicoquimica.laboratorio_analisis.export.excel'
        ])
                        ...
                        <div class="filter-group">
                            ...
                            <div class="search-input-container">
                                ...
                                <input 
                                    ...
                                    placeholder="Ej: Equipo, reactivo..."
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        ...
                                        <form action="{{ route('fisicoquimica.laboratorio_analisis.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/fisicoquimica/laboratorio-analisis/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    ...
                    editForm.action = `/fisicoquimica/laboratorio-analisis/${itemId}`;
