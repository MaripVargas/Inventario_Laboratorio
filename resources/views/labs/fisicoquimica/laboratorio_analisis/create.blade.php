...
@section('title', 'Agregar Artículo - Laboratorio de Análisis')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Nuevo artículo de laboratorio de análisis')
...
<div class="max-w-4xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo artículo - Laboratorio de Análisis</h2>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('fisicoquimica.laboratorio_analisis.store') }}" class="modern-form space-y-6">
                @csrf
