...
@section('title', 'Agregar Equipo de Secado de Suelos')
@section('page-title', 'Lab. Físico Química')
@section('page-subtitle', 'Registrar nuevo equipo de Secado de Suelos')
...
<div class="max-w-5xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo Equipo de Secado de Suelos</h2>
            <a href="{{ route('fisicoquimica.secado_suelos_equipos.index') }}" class="modern-btn modern-btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver
            </a>
        </div>

        <div class="card-body">
            <form action="{{ route('fisicoquimica.secado_suelos_equipos.store') }}" method="POST" class="modern-form space-y-6">
                @csrf
