...
@section('title', 'Equipos de Secado de Suelos - Físico Química')
@section('page-title', 'Lab. Físico Química')
@section('page-subtitle', 'Gestión de equipos de secado de suelos')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center flex-wrap gap-3">
                <h2 class="text-xl font-semibold text-gray-900">Equipos de Secado de Suelos</h2>
                <div class="flex gap-2">
                    <a href="{{ route('fisicoquimica.secado_suelos.index') }}" class="modern-btn modern-btn-secondary">
                        <i class="fas fa-arrow-left"></i> Volver a Secado de Suelos
                    </a>
                    <a href="{{ route('fisicoquimica.secado_suelos_equipos.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.secado_suelos_equipos.export.pdf',
            'excelRoute' => 'fisicoquimica.secado_suelos_equipos.export.excel'
        ])
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        <a href="{{ route('fisicoquimica.secado_suelos_equipos.edit', $item->id) }}" class="btn btn-warning btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('fisicoquimica.secado_suelos_equipos.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="14" class="empty-state">
                                    <div class="empty-state-content">
                                        ...
                                        <p>Agrega un nuevo equipo de Secado de Suelos</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
