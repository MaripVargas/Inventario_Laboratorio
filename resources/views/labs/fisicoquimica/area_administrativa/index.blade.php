...
@section('title', 'Área Administrativa - Físico Química')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Gestión de área administrativa')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-900">Área Administrativa</h2>
                <a href="{{ route('fisicoquimica.area_administrativa.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.area_administrativa.export.pdf',
            'excelRoute' => 'fisicoquimica.area_administrativa.export.excel'
        ])
                        ...
                        <div class="filter-group">
                            ...
                            <div class="search-input-container">
                                ...
                                <input 
                                    ...
                                    placeholder="Ej: Artículo, material..."
                ...
                <table class="modern-table" style="min-width: 1200px;">
                    <thead>
                        <tr>
                            ...
                            <th class="table-header" style="width: 220px;">Nombre del Artículo</th>
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        ...
                                        <form action="{{ route('fisicoquimica.area_administrativa.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="modal-body">
                ...
                <form id="editForm" style="display:none;" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="nombre_item">Nombre del artículo <span style="color: red;">*</span></label>
                            <input type="text" name="nombre_item" id="nombre_item" class="modern-input" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_placa" id="no_placa" class="modern-input">
                        </div>
                        <div>
                            <label for="fecha_adq">Fecha de Adquisición</label>
                            <input type="date" name="fecha_adq" id="fecha_adq" class="modern-input">
                        </div>
                        <div>
                            <label for="valor">Valor (COP)</label>
                            <input type="number" step="0.01" name="valor" id="valor" class="modern-input">
                        </div>
                        <div>
                            <label for="nombre_responsable">Nombre del Responsable</label>
                            <input type="text" name="nombre_responsable" id="nombre_responsable" class="modern-input">
                        </div>
                        <div>
                            <label for="cedula">Cédula</label>
                            <input type="text" name="cedula" id="cedula" class="modern-input">
                        </div>
                        <div>
                            <label for="vinculacion">Vinculación</label>
                            <input type="text" name="vinculacion" id="vinculacion" class="modern-input">
                        </div>
                        <div>
                            <label for="fecha_registro">Fecha Registro</label>
                            <input type="date" name="fecha_registro" id="fecha_registro" class="modern-input">
                        </div>
                        <div>
                            <label for="usuario_registra">Usuario que Registra</label>
                            <input type="text" name="usuario_registra" id="usuario_registra" class="modern-input">
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/fisicoquimica/area-administrativa/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    document.getElementById('nombre_item').value = data.nombre_item || '';
                    document.getElementById('cantidad').value = data.cantidad || '';
                    document.getElementById('unidad').value = data.unidad || '';
                    document.getElementById('no_placa').value = data.no_placa || '';
                    document.getElementById('fecha_adq').value = data.fecha_adq || '';
                    document.getElementById('valor').value = data.valor || '';
                    document.getElementById('nombre_responsable').value = data.nombre_responsable || '';
                    document.getElementById('cedula').value = data.cedula || '';
                    document.getElementById('vinculacion').value = data.vinculacion || '';
                    document.getElementById('fecha_registro').value = data.fecha_registro || '';
                    document.getElementById('usuario_registra').value = data.usuario_registra || '';
                    document.getElementById('detalle').value = data.detalle || '';
                    editForm.action = `/fisicoquimica/area-administrativa/${itemId}`;
