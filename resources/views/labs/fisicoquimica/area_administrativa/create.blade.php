...
@section('title', 'Agregar Artículo - Área Administrativa')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Nuevo artículo de área administrativa')
...
<div class="max-w-5xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo Artículo - Área Administrativa</h2>
            <a href="{{ route('fisicoquimica.area_administrativa.index') }}" class="modern-btn modern-btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver
            </a>
        </div>

        <div class="card-body">
            <form action="{{ route('fisicoquimica.area_administrativa.store') }}" method="POST" class="modern-form space-y-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="nombre_item" class="form-input" value="{{ old('nombre_item') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="number" name="cantidad" class="form-input" value="{{ old('cantidad') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="unidad" class="form-input" value="{{ old('unidad') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="no_placa" class="form-input" value="{{ old('no_placa') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="date" name="fecha_adq" class="form-input" value="{{ old('fecha_adq') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="number" step="0.01" name="valor" class="form-input" value="{{ old('valor') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <select name="nombre_responsable" id="nombre_responsable_select" class="form-input custom-select">
                                ...
                                @php $currentResponsable = old('nombre_responsable'); @endphp
                                ...
                                @if($currentResponsable && !collect($catalogos['responsables'])->pluck('nombre')->contains($currentResponsable))
                                    <option value="{{ $currentResponsable }}" data-cedula="{{ old('cedula') }}" selected>{{ $currentResponsable }}</option>
                                @endif
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="cedula" id="cedula_input" class="form-input" value="{{ old('cedula') }}" list="cedulasList">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="date" name="fecha_registro" class="form-input" value="{{ old('fecha_registro') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="usuario_registra" class="form-input" value="{{ old('usuario_registra') }}" list="usuariosList">
                        </div>
                    </div>
                    <div class="form-group md:col-span-2">
                        ...
                        <div class="textarea-container">
                            ...
                            <textarea name="detalle" rows="3" class="form-textarea">{{ old('detalle') }}</textarea>
                        </div>
                    </div>
                </div>
