...
@section('title', 'Agregar Artículo - Adsorción Atómica')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Nuevo artículo de adsorción atómica')
...
<div class="max-w-4xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo artículo - Adsorción Atómica</h2>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('fisicoquimica.adsorcion.store') }}" class="modern-form space-y-6">
                @csrf
