...
@section('title', 'Depósito - Físico Química')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Gestión de depósito')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-900">Depósito</h2>
                <a href="{{ route('fisicoquimica.deposito.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.deposito.export.pdf',
            'excelRoute' => 'fisicoquimica.deposito.export.excel'
        ])
                        ...
                        <div class="filter-group">
                            ...
                            <div class="search-input-container">
                                ...
                                <input 
                                    ...
                                    placeholder="Ej: Material, herramienta..."
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        ...
                                        <form action="{{ route('fisicoquimica.deposito.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/fisicoquimica/deposito/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    ...
                    editForm.action = `/fisicoquimica/deposito/${itemId}`;
