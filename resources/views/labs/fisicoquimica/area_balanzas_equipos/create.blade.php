...
@section('title', 'Agregar Equipo de Área de Balanzas')
@section('page-title', 'Lab. Físico Química')
@section('page-subtitle', 'Registrar nuevo equipo de Área de Balanzas')
...
<div class="max-w-5xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo Equipo de Área de Balanzas</h2>
            <a href="{{ route('fisicoquimica.area_balanzas_equipos.index') }}" class="modern-btn modern-btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver
            </a>
        </div>

        <div class="card-body">
            <form action="{{ route('fisicoquimica.area_balanzas_equipos.store') }}" method="POST" class="modern-form space-y-6">
                @csrf
