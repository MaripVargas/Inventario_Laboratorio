...
@section('title', 'Equipos de Laboratorio de Análisis - Físico Química')
@section('page-title', 'Lab. Físico Química')
@section('page-subtitle', 'Gestión de equipos de laboratorio de análisis')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center flex-wrap gap-3">
                <h2 class="text-xl font-semibold text-gray-900">Equipos de Laboratorio de Análisis</h2>
                <div class="flex gap-2">
                    <a href="{{ route('fisicoquimica.laboratorio_analisis.index') }}" class="modern-btn modern-btn-secondary">
                        <i class="fas fa-arrow-left"></i> Volver a Laboratorio de Análisis
                    </a>
                    <a href="{{ route('fisicoquimica.laboratorio_analisis_equipos.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.laboratorio_analisis_equipos.export.pdf',
            'excelRoute' => 'fisicoquimica.laboratorio_analisis_equipos.export.excel'
        ])
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        <a href="{{ route('fisicoquimica.laboratorio_analisis_equipos.edit', $item->id) }}" class="btn btn-warning btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('fisicoquimica.laboratorio_analisis_equipos.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="14" class="empty-state">
                                    <div class="empty-state-content">
                                        ...
                                        <p>Agrega un nuevo equipo de Laboratorio de Análisis</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
...
.modern-btn-primary { background: linear-gradient(135deg, #2563eb, #3b82f6); color: #ffffff !important; box-shadow: 0 4px 12px rgba(37, 99, 235, 0.15); font-weight: 600; }
.modern-btn-secondary { background: linear-gradient(135deg, #6b7280, #4b5563); color: #ffffff !important; box-shadow: var(--shadow-sm); font-weight: 600; }
