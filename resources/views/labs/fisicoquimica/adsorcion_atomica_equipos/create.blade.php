...
@section('title', 'Agregar Equipo de Adsorción Atómica')
@section('page-title', 'Lab. Físico Química')
@section('page-subtitle', 'Registrar nuevo equipo de Adsorción Atómica')
...
<div class="max-w-5xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo Equipo de Adsorción Atómica</h2>
        ...
        <div class="card-body">
            <form action="{{ route('fisicoquimica.adsorcion_equipos.store') }}" method="POST" class="modern-form space-y-6">
                @csrf
