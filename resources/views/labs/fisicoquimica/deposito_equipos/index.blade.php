...
@section('title', 'Equipos de Depósito - Físico Química')
@section('page-title', 'Lab. Físico Química')
@section('page-subtitle', 'Gestión de equipos de depósito')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center flex-wrap gap-3">
                <h2 class="text-xl font-semibold text-gray-900">Equipos de Depósito</h2>
                <div class="flex gap-2">
                    <a href="{{ route('fisicoquimica.deposito.index') }}" class="modern-btn modern-btn-secondary">
                        <i class="fas fa-arrow-left"></i> Volver a Depósito
                    </a>
                    <a href="{{ route('fisicoquimica.deposito_equipos.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.deposito_equipos.export.pdf',
            'excelRoute' => 'fisicoquimica.deposito_equipos.export.excel'
        ])
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        <a href="{{ route('fisicoquimica.deposito_equipos.edit', $item->id) }}" class="btn btn-warning btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('fisicoquimica.deposito_equipos.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="14" class="empty-state">
                                    <div class="empty-state-content">
                                        ...
                                        <p>Agrega un nuevo equipo de Depósito</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
