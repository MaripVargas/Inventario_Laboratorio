...
@section('title', 'Secado de Suelos - Físico Química')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Gestión de secado de suelos')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-900">Secado de Suelos</h2>
                <a href="{{ route('fisicoquimica.secado_suelos.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.secado_suelos.export.pdf',
            'excelRoute' => 'fisicoquimica.secado_suelos.export.excel'
        ])
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        ...
                                        <form action="{{ route('fisicoquimica.secado_suelos.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/fisicoquimica/secado-suelos/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    ...
                    editForm.action = `/fisicoquimica/secado-suelos/${itemId}`;
