...
@section('title', 'Área de Balanzas - Físico Química')
@section('page-title', 'Laboratorio de Físico Química')
@section('page-subtitle', 'Gestión de área de balanzas')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-900">Área de Balanzas</h2>
                <a href="{{ route('fisicoquimica.area_balanzas.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'fisicoquimica.area_balanzas.export.pdf',
            'excelRoute' => 'fisicoquimica.area_balanzas.export.excel'
        ])
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        ...
                                        <form action="{{ route('fisicoquimica.area_balanzas.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/fisicoquimica/area-balanzas/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    ...
                    editForm.action = `/fisicoquimica/area-balanzas/${itemId}`;
