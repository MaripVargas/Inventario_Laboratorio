...
@section('title', 'Vidriería - Zoología ')
@section('page-title', 'Lab. Zoología ')
@section('page-subtitle', 'Gestión de vidriería del laboratorio de Zoología ')
...
<div class="modern-inventory-container">
    <div class="card mb-6 modern-card">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'zoologia.vidrieria.export.pdf',
            'excelRoute' => 'zoologia.vidrieria.export.excel'
        ])
