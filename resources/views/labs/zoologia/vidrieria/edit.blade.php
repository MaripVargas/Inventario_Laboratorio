...
@section('title', 'Editar Vidriería - Zoología')
@section('page-title', 'Laboratorio de Zoología y Botánica')
@section('page-subtitle', 'Editar artículo de vidriería')
...
<div class="max-w-4xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Editar Vidriería</h2>
        ...
        <div class="card-body">
            <form action="{{ route('zoologia.vidrieria.update', $item->id) }}" method="POST" class="modern-form space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="nombre_item" required class="form-input" value="{{ old('nombre_item', $item->nombre_item) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="volumen" class="form-input" value="{{ old('volumen', $item->volumen) }}">
                        </div>
                    </div>
