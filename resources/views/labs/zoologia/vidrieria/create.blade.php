...
@section('title', 'Agregar Vidriería - Zoología')
@section('page-title', 'Laboratorio de Zoología y Botánica')
@section('page-subtitle', 'Registrar nuevo artículo de vidriería')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="nombre_item" required class="form-input" placeholder="Ej: Matraz, Probeta..." value="{{ old('nombre_item') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="unidad" class="form-input" placeholder="Ej: piezas" value="{{ old('unidad') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <div class="textarea-container">
                            ...
                            <textarea name="detalle" rows="3" class="form-textarea" placeholder="Detalles o características...">{{ old('detalle') }}</textarea>
                        </div>
                    </div>
                </div>
