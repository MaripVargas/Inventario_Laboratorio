...
<div class="max-w-4xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            ...
            <a href="{{ route('biotecnologia.utileria.index') }}" class="modern-btn modern-btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver
            </a>
        </div>

        <div class="card-body">
            <form action="{{ route('biotecnologia.utileria.store') }}" method="POST" class="modern-form space-y-6">
                @csrf
