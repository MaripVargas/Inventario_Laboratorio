    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('biotecnologia.utileria.create') }}" class="modern-btn modern-btn-primary">
        ...
        @include('components.export-buttons', [
            'pdfRoute' => 'biotecnologia.utileria.export.pdf',
            'excelRoute' => 'biotecnologia.utileria.export.excel'
        ])
...
@endpush
    ...
    <i class="fas fa-edit"></i>
                                        ...
                                        <form action="{{ route('biotecnologia.utileria.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/biotecnologia/utileria/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    // Llenar formulario
                    ...
                    editForm.action = `/biotecnologia/utileria/${itemId}`;
