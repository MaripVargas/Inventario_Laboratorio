...
@section('title', 'Siembra - Biotecnología')
@section('page-title', 'Laboratorio de Biotecnología')
@section('page-subtitle', 'Gestión de siembras del laboratorio')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-900">Lista de Siembras</h2>
                <a href="{{ route('biotecnologia.siembra.create') }}" class="modern-btn modern-btn-primary">
                        ...
                        <div class="filter-group">
                            ...
                            <div class="search-input-container">
                                ...
                                <input 
                                    ...
                                    placeholder="Ej: Explante, cultivo..."
                    ...
                    <tbody>
                        @forelse($items as $item)
                            <tr class="table-row">
                                ...
                                <td class="table-cell font-semibold text-gray-800">{{ $item->nombre_siembra }}</td>
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        <a href="{{ route('biotecnologia.siembra.editForm', $item->id) }}" class="btn btn-warning btn-sm" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('biotecnologia.siembra.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            fetch(`/biotecnologia/siembra/${itemId}/edit`)
                .then(res => res.json())
                .then(data => {
                    document.getElementById('nombre_siembra').value = data.nombre_siembra || '';
                    document.getElementById('cantidad').value = data.cantidad || '';
                    document.getElementById('unidad').value = data.unidad || '';
                    document.getElementById('detalle').value = data.detalle || '';

                    editForm.action = `/biotecnologia/siembra/${itemId}`;
