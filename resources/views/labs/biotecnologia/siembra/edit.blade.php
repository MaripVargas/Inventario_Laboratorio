...
@section('title', 'Editar Siembra - Biotecnología')
@section('page-title', 'Laboratorio de Biotecnología')
@section('page-subtitle', 'Editar registro de siembra')
...
<div class="max-w-4xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Editar Siembra</h2>
        ...
        <div class="card-body">
            <form action="{{ route('biotecnologia.siembra.update', $item->id) }}" method="POST" class="modern-form space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="nombre_siembra" required class="form-input" value="{{ old('nombre_siembra', $item->nombre_siembra) }}">
                        </div>
                    </div>
