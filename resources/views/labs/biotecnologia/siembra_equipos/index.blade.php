...
@section('title', 'Equipos de Siembra - Biotecnología')
@section('page-title', 'Laboratorio de Biotecnología')
@section('page-subtitle', 'Gestión de equipos utilizados en siembra')
    ...
    <div class="card mb-6 modern-card">
        <div class="card-header modern-header">
            <div class="flex justify-between items-center flex-wrap gap-3">
                <h2 class="text-xl font-semibold text-gray-900">Equipos de Siembra</h2>
                <div class="flex gap-2">
                    <a href="{{ route('biotecnologia.siembra.index') }}" class="modern-btn modern-btn-secondary">
                        <i class="fas fa-arrow-left"></i> Volver a Siembras
                    </a>
                    <a href="{{ route('biotecnologia.siembra_equipos.create') }}" class="modern-btn modern-btn-primary">
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-cell sticky-column">
                                    <div class="action-buttons d-flex align-items-center gap-2">
                                        <a href="{{ route('biotecnologia.siembra_equipos.edit', $item->id) }}" class="btn btn-warning btn-sm" title="Editar"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('biotecnologia.siembra_equipos.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="14" class="empty-state">
                                    <div class="empty-state-content">
                                        ...
                                        <p>Agrega un nuevo equipo de siembra</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
