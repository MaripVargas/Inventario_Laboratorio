...
@section('title', 'Editar Equipo de Siembra')
@section('page-title', 'Laboratorio de Biotecnología')
@section('page-subtitle', 'Actualizar equipo utilizado en siembra')
...
<div class="max-w-5xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Editar Equipo de Siembra</h2>
        ...
        <div class="card-body">
            <form action="{{ route('biotecnologia.siembra_equipos.update', $item->id) }}" method="POST" class="modern-form space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="text" name="vinculacion" class="form-input" value="{{ old('vinculacion', $item->vinculacion) }}" list="vinculacionesList">
                        </div>
                    </div>
                    <div class="form-group">
