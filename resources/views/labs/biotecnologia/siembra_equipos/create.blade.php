...
@section('title', 'Agregar Equipo de Siembra')
@section('page-title', 'Laboratorio de Biotecnología')
@section('page-subtitle', 'Registrar nuevo equipo para siembra')
...
<div class="max-w-5xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        <div class="card-header modern-form-header flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Nuevo Equipo de Siembra</h2>
        ...
        <div class="card-body">
            <form action="{{ route('biotecnologia.siembra_equipos.store') }}" method="POST" class="modern-form space-y-6">
                @csrf
