...
@section('title', 'Editar Item - Incubación')
@section('page-title', 'Editar Item de Incubación')
@section('page-subtitle', 'Actualiza la información del item')
...
<div class="max-w-6xl mx-auto modern-form-container">
    <div class="card modern-form-card">
        ...
        <div class="card-body">
            <form action="{{ route('biotecnologia.incubacion.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="modern-form space-y-6">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="ir_id" required 
                                       class="form-input"
                                       placeholder="Ej: IR-001" value="{{ old('ir_id', $item->ir_id) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="iv_id" 
                                       class="form-input"
                                       placeholder="Ej: IV-001" value="{{ old('iv_id', $item->iv_id) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="cod_regional" required 
                                       class="form-input"
                                       placeholder="Ej: REG-001" value="{{ old('cod_regional', $item->cod_regional) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="cod_centro" required 
                                       class="form-input"
                                       placeholder="Ej: CEN-001" value="{{ old('cod_centro', $item->cod_centro) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="desc_almacen" required 
                                       class="form-input"
                                       placeholder="Ej: Almacén Principal" value="{{ old('desc_almacen', $item->desc_almacen) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="no_placa" required 
                                       class="form-input"
                                       placeholder="Ej: PL-001" value="{{ old('no_placa', $item->no_placa) }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="consecutivo" required 
                                       class="form-input"
                                       placeholder="Ej: CON-001" value="{{ old('consecutivo', $item->consecutivo) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="desc_sku" required 
                                       class="form-input"
                                       placeholder="Ej: SKU-001" value="{{ old('desc_sku', $item->desc_sku) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="serial" 
                                       class="form-input"
                                       placeholder="Ej: SN123456789" value="{{ old('serial', $item->serial) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="gestion" required 
                                       class="form-input"
                                       placeholder="Ej: 2024" value="{{ old('gestion', $item->gestion) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-container">
                            ...
                            <select name="tipo_material" id="tipo_material" class="form-select" required>
                                ...
                                <option value="Equipos" {{ old('tipo_material', $item->tipo_material) == 'Equipos' ? 'selected' : '' }}>Equipos</option>
                                <option value="Mueblería" {{ old('tipo_material', $item->tipo_material) == 'Mueblería' ? 'selected' : '' }}>Mueblería</option>
                                <option value="Vidrieria" {{ old('tipo_material', $item->tipo_material) == 'Vidrieria' ? 'selected' : '' }}>Vidrieria</option>
                            </select>
                        </div>
                        @error('tipo_material')
                    ...
                    <div class="form-group">
                        ...
                        <div class="textarea-container">
                            ...
                            <textarea name="descripcion_elemento" rows="3" required
                                      class="form-textarea"
                                      placeholder="Descripción detallada del elemento...">{{ old('descripcion_elemento', $item->descripcion_elemento) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="textarea-container">
                            ...
                            <textarea name="atributos" rows="3"
                                      class="form-textarea"
                                      placeholder="Atributos adicionales del elemento...">{{ old('atributos', $item->atributos) }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="number" name="valor_adq" required min="0" step="0.01"
                                       class="form-input"
                                       placeholder="0.00" value="{{ old('valor_adq', $item->valor_adq) }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-container">
                                ...
                                <select name="uso" required class="form-select">
                                    ...
                                    <option value="formacion" {{ old('uso', $item->uso) == 'formacion' ? 'selected' : '' }}>Formación</option>
                                    <option value="servicios_tecnologicos" {{ old('uso', $item->uso) == 'servicios_tecnologicos' ? 'selected' : '' }}>Servicios Tecnológicos</option>
                                    <option value="investigacion" {{ old('uso', $item->uso) == 'investigacion' ? 'selected' : '' }}>Investigación</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-container">
                                ...
                                <input type="text" name="contrato" required 
                                       class="form-input"
                                       placeholder="Ej: PCN-2024-001" value="{{ old('contrato', $item->contrato) }}">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <select name="nombre_responsable" id="nombre_responsable" class="form-select">
                                    ...
                                    @foreach($catalogos['responsables'] ?? [] as $responsable)
                                        <option value="{{ $responsable['nombre'] }}" 
                                                ...
                                                {{ old('nombre_responsable', $item->nombre_responsable) == $responsable['nombre'] ? 'selected' : '' }}>
                                            {{ $responsable['nombre'] }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            @if($item->foto)
                                <div class="mb-3">
                                    <img src="{{ asset('uploads/biotecnologia_incubacion/' . $item->foto) }}" alt="Foto actual" style="max-width: 200px; border-radius: 8px;">
                            ...
                            <div class="file-upload-container">
                                ...
                                <label for="foto" class="file-upload-label">
                                    <span class="file-upload-text">{{ $item->foto ? 'Cambiar archivo' : 'Seleccionar archivo' }}</span>
